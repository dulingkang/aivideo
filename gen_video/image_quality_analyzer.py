...
class FaceSimilarityResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "face_detected_in_generated": self.face_detected_in_generated,
            "face_detected_in_reference": self.face_detected_in_reference,
            "error": self.error
        }
...
class ImageQualityAnalyzer:
    ...
    def _load_face_analyzer(self):
        ...
        try:
            ...
            # 获取模型路径
            model_root = self.config.get("insightface_root", "models")
